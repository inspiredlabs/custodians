...
On `Thursday 29 July` we covered the following – I expanded these ideas to help structure the project:
...
- How will website content stategically promote the app:
  ...
  - on social media.
  - SEO keywords.
- People have a sense of responsibility towards the environment which aligns with The Custodians goal – but, how do we know the app is working?
...
Streaming media requires considerable resources, so it can be valuable to use existing services. By understanding our audience we should be able to thoughtfully tailor the user experience while saving energy.
...
🚀 **[CUSTODIANS.SITE](https://custodians.site/) staging-environment is live**
